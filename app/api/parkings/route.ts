  ...
  const featureCollection = {
    ...
    features: rows.map((row) => ({
      ...
      properties: {
        ...
        moto_spaces: row.moto_spaces,
        moto_ev_spaces: row.moto_ev_spaces,
        carsharing_spaces: row.carsharing_spaces,
        carpool_spaces: row.carpool_spaces,
        relais_spaces: row.relais_spaces,
